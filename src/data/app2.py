...
#
#
# def create_selected_skills_output(selected_skills_dict, header="Selected skills"):
...
#             html.Div([
#                 create_toggle_switch()[0],
#                 html.Div(id="selected-skills-output", className='pretty_container'),
#                 html.Div(id="mode-content", children=[create_probability_chart(),
#                                                       dcc.RadioItems(
#                                                           id="job-radio"),
...
#     if value:
#         return create_simulate_skills_content()
#     else:
#         return create_probability_chart()
#
#
# @app.callback(
...
#      for category in categories_skills.keys()]
# )
# def update_selected_skills(target_jop, *selected_skills):
#     selected_skills = [skill for skills in selected_skills for skill in (skills or [])]
#     if target_jop and len(selected_skills) > 3:
#         simulate_skills_dict = simulate_utils.get_recommended_categories(target_jop, selected_skills, 10)
#         return create_selected_skills_output(simulate_skills_dict, "Simulated Skills"), ''
#     else:
